...
<body>
  ...
  <div class="row">
    <div class="col-md-8">
      <section>      
        <h1 class="entry-title"><span>Upload the application form</span> </h1>
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="paper2.php" > 
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <input name="submit" type="submit" value="Upload files" class="btn btn-primary">
          </div>
           </div>   
          </div>
        </div>
