<?php 
  ...
  $dbhost = 'localhost';
            ...
            $sql = "SELECT * FROM `numb` WHERE `avail` = 'available' ";
    ...
    <div class="col-md-8">
      <section>      
        ...
        <hr>
          ...
          <label class="control-label col-sm-3">Enter DL no<span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="text" class="form-control" name="dl" id="emailid" placeholder="Enter your vehicle register number " value="" required="required">
            </div>
            <small>  </small> </div>
        </div>      
        <div class="form-group">
          <label class="control-label col-sm-3">Enter vehicle register no<span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="text" class="form-control" name="reg" id="emailid" placeholder="Enter your vehicle register number " value="" required="required">
            </div>
            <small>  </small> </div>
        </div>
        ...
        <div class="form-group">
          <label class="control-label col-sm-3">Number plate id <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="text" class="form-control" name="password" id="password" placeholder="e.gID" value="">
           </div>   
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">Amount Paid<span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="text" class="form-control" name="eng" id="password" placeholder="Enter amount paid at office " value="" min="18">
           </div>   
          </div>
        </div>
       
          <div class="col-xs-offset-3 col-xs-10">
            <input name="Submit" type="submit" value="Apply for fancy number" class="btn btn-primary">
          </div>
        </div>
      </form>
    </div>
