  ...
  <div class="row">
    <div class="col-md-8">
      <section>      
        ...
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="lic.php" >        
        <div class="form-group">
          <label class="control-label col-sm-3">Name <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="text" class="form-control" name="emailid" id="emailid" placeholder="Name on ID  " value="" required="required">
            </div>
            <small>  </small> </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
            <label>
            <input name="gender" type="radio" value="MC50CC" checked="checked" >
        ...
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
            <label>
            <input name="bgrup" type="radio" value="A+" checked="checked">
            A+</label></br>
            <label>
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <input type="date" class="form-control" name="contactnum" id="contactnum" placeholder="Enter your Primary contact no."  max="1999-12-31">
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-6 wow fadeInRight delay-02s">
            ...
            <div class="icon-text">
             <h3 class="txt-tl">Vehicle Registration</h3></a>
