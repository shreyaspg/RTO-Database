      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="col-md-6 wow fadeInRight delay-02s">
            ...
            <div class="icon-text">
             <h3 class="txt-tl">Apply for license</h3>
              <p class="txt-para"><a href="llicense.php">Learner's License</a>   <a href="dlic.php">  Driving License</a></br>
              <a href="../report/rec.php">Print License</a>
              </p>
            </div>
          </div>
          <div class="col-md-6 wow fadeInRight delay-02s">
            ...
            <div class="icon-text">
              <a style="color:black"><h3 class="txt-tl">Vehicle Registration</h3></a>
          ...
          <div class="col-md-6 wow fadeInRight delay-02s">
            ...
            <div class="icon-text">
             <h3 class="txt-tl">Request Fancy Number</h3>
               <p class="txt-para"><a href="fancy.php">Get a custom fancy Number</a> </p>
            </div>
          </div>
