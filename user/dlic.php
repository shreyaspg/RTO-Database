  ...
  <div class="row">
    <div class="col-md-8">
      <section>      
        ...
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="ddlic.php" >        
        <div class="form-group">
          <label class="control-label col-sm-3">Enter License ID<span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="number" class="form-control" name="license" id="emailid" placeholder="Enter your License ID " value="" required="required">
            </div>
            <small>  </small> </div>
        </div>
        ...
        <!--<div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              ...
              <input type="number" class="form-control" name="password" id="password" placeholder="Enter your age" value="" min="18">
           </div>   
          </div>
        </div>-->
        
        <!--<div class="form-group">
          <label class="control-label col-sm-3">Applying for <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
            <label>
            <input name="gender" type="radio" value="MC50CC" >
            MC 50CC (Motorcycle 50 cc)</label></br>
            <label>
            <input name="gender" type="radio" value="LMV-NT" >
            LMV-NT </label></br>
            <label>
            <input name="gender" type="radio" value="FVG" >
            FVG</label></br>
            <label>
            <input name="gender" type="radio" value="MCEX50CC" >
            MC EX50CC </label></br>

            <label>
            <input name="gender" type="radio" value="MCWGorM/CYCL.WG " >
            MCWG or M / CYCL.WG </label></br>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
            <label>
            <input name="bgrup" type="radio" value="A+" >
            A+</label></br>
            <label>
            <input name="bgrup" type="radio" value="A-" >
            A-</label></br>
            <label>
            <input name="bgrup" type="radio" value="B+" >
            B+</label></br>
            <label>
            <input name="bgrup" type="radio" value="B-" >
            B- </label></br>
            <label>
            <input name="bgrup" type="radio" value="AB+" >
            AB+ </label></br>
            <label>
            <input name="bgrup" type="radio" value="AB-" >
            AB- </label></br>
            <label>
            <input name="bgrup" type="radio" value="O+" >
            O+ </label></br>
            <label>
            <input name="bgrup" type="radio" value="O-" >
            O- </label></br>
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <input type="date" class="form-control" name="contactnum" id="contactnum" placeholder="Enter your Primary contact no." value="">
            </div>
          </div>
        </div>
        -->
          ...
          <div class="col-xs-offset-3 col-xs-10">
            <input name="Submit" type="submit" value="Apply for License" class="btn btn-primary">
          </div>
        </div>
      </form>
    </div>
          ...
          <div class="col-md-6 wow fadeInRight delay-02s">
            ...
            <div class="icon-text">
             <h3 class="txt-tl">Apply for license</h3>
              <p class="txt-para"><a href="llicense.php" style="color:black">Learner's License</a>   <a href="dlic.php" style="color:black">    Driving License</a></p>
            </div>
          </div>
          <div class="col-md-6 wow fadeInRight delay-02s">
            <div class="icon">
            ...
            <div class="icon-text">
              ...
              <a href="vehicle.php" style="color:black" class="txt-para">Registration And Renewal </a>
            </div>
          </div>
