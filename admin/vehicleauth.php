<?php 
  session_start();
   $dbhost = 'localhost';
            ...
            $sql = "SELECT * FROM `vehicle` WHERE `status` = 'not issued' ";
...
<body>
  ...
  <table class="data-table">
    ...
    while ($row = mysqli_fetch_array($result))
    {
      ...
      $sql2="SELECT * FROM doc2 WHERE `email`='$email'";
      ...
      while ($row2 = mysqli_fetch_array($result_set))
    {
      echo '<tr>
          ...
          ?>
    <div class='my'>
         <td> <a href="../uploads/<?php echo $row2['file'] ?>" target="_blank">view document</a></td>
         </div>
          <?php
        }
    }?>
  ...
  <div class="row">
    <div class="col-md-8">
      <section>      
        ...
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="vehicleauthh.php" >        
        <div class="form-group">
          <label class="control-label col-sm-3">Enter Vehicle Reg ID  <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="text" class="form-control" name="emailid" id="emailid" placeholder="Enter Id" value="" required="required">
            </div>
            <small>  </small> </div>
        </div>
         <div class="col-xs-offset-3 col-xs-10">
            <input name="Submit" type="submit" value="Authorize Vehicle Registration" class="btn btn-primary">
          </div>
          </br>
          </br>
          </br>
          <div class="col-xs-offset-3 col-xs-10">
            <input name="SSubmit" type="submit" value="Reject Vehicle Registration" class="btn btn-primary">
        </div>
      </form>
    </div>
</div>
