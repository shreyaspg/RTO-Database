<?php 
  ...
  $dbhost = 'localhost';
            ...
            $sql = "SELECT * FROM `dlicense` WHERE `status` = 'not issued' ";

            $result = mysqli_query($conn, $sql);
            $sql2="SELECT * FROM drivdoc";
...
<body>
  ...
  <table class="data-table">
    ...
    while ($row = mysqli_fetch_array($result))
    {
      ...
      $sql2="SELECT * FROM drivdoc WHERE `email`='$email'";
  ...
  <div class="row">
    <div class="col-md-8">
      <section>      
        ...
        <hr>
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="dlic.php" >        
        <div class="form-group">
          <label class="control-label col-sm-3">Enter Driving License ID  <span class="text-danger">*</span></label>
         ...
         <div class="col-xs-offset-3 col-xs-10">
            <input name="Submit" type="submit" value="Authorize License" class="btn btn-primary">
          </div>
          </br>
          </br>
          </br>
